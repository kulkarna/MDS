Use Libertypower
       ...
       from(
                     select distinct a.AccountNumber,a.UtilityCode,A.FROMDATE,a.ToDate from Libertypower..UsageConsolidated a(nolock)
                     where a.UtilityCode='CMP'                     
					  and a.Active=1
					 group by a.AccountNumber,a.UtilityCode,A.FromDate,A.ToDate
       ...
       and t.FromDate=b.FromDate
       and t.ToDate=b.ToDate and b.Active=1
	 inner join (select distinct a.AccountNumber,a.UtilityCode,A.FROMDATE,a.ToDate from Libertypower..UsageConsolidated a(nolock)
                     where a.UtilityCode='CMP' 
					 and a.MeterNumber=''                    
					 and a.Active=1
					 group by a.AccountNumber,a.UtilityCode,A.FromDate,A.ToDate,a.MeterNumber)a
					 on b.AccountNumber=a.AccountNumber
					 and b.UtilityCode=a.UtilityCode
					 and b.FromDate=a.FromDate
					 and b.ToDate=a.ToDate
					 and b.active=1
					 and cast(b.Created as date)>'2015-01-01'
	   ...
	   inner join (select a.accountnumber,a.utilitycode,max(a.id) as ID 
					...
					and a.ToDate=eu.EndDate
					 and eu.UnitOfMeasurement='KH' and eu.MeasurementSignificanceCode='51'
