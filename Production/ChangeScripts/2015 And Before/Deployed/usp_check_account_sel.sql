USE [lp_enrollment]
GO
/****** Object:  StoredProcedure [dbo].[usp_check_account_sel]    Script Date: 04/16/2012 13:33:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[usp_check_account_sel]
(@p_username                                        nchar(100),
 @p_contract_nbr                                    char(12) ,
 @p_account_id                                      char(12) = 'NONE',
 @p_account_number                                  varchar(30) =  'NONE',
 @p_check_type                                      varchar(50),
 @p_check_request_id                                varchar(50),
...
begin
   ...
   from lp_account..account WITH (NOLOCK) --REMOVE INDEX USE. TICKET 18281 with (NOLOCK INDEX = account_idx1)
