...
/****** Object:  Trigger [zAuditUtilityUpdate]    Script Date: 03/11/2013 16:36:19 ******/
...
/****** Object:  Trigger [dbo].[zAuditUtilityUpdate]    Script Date: 03/11/2013 16:36:19 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SET @ColumnsChanged = 
	  (SELECT CASE WHEN isnull(a.[UtilityCode],0) <> isnull(b.[UtilityCode],0) 
		...
		+ CASE WHEN isnull(a.[Flag814C],0) <> isnull(b.[Flag814C],0) 
		THEN 'Flag814C' + ',' ELSE '' END
	FROM inserted a
