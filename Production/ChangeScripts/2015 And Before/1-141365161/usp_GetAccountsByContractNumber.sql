...
CREATE PROCEDURE [dbo].[usp_GetAccountsByContractNumber]
...
BEGIN
	...
	SELECT	AC.ContractID, AC.ContractNumber, AC.SignedDate, AC.StartDate, A.AccountID, A.AccountNumber, A.Zone, A.LoadProfile, A.ServiceRateClass, A.StratumVariable, A.UtilityID, A.BillingGroup,AC.AccountContractID, AccountNameID
	INTO	#Account
