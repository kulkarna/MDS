USE [Libertypower]
GO
/****** Object:  StoredProcedure [dbo].[usp_RateChangeInsert]    Script Date: 01/29/2014 18:05:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/* 1/29/2014 - Thiago Nogueira

 * Added @Send814C parameter

 *******************************************************************************/

ALTER PROCEDURE [dbo].[usp_RateChangeInsert]
(
