------------------------------------------------------------
--Insert value for 2 new fields to deal_contract table
--5/21/2014 36356 Unsubmitted deals
-------------------------------------------------------------------------
USE [Lp_deal_capture]
GO
/****** Object:  StoredProcedure [dbo].[usp_contract_ins]    Script Date: 05/20/2014 13:48:24 ******/
SET ANSI_NULLS ON
GO
...
-- Date : 8/5/2013   
-- Altered for Autogeneration to work for Paper contracts
--The code to insert into print table is commented in deal_contract_empty_ins procedure, 
--So, we need not check in the print table for paper contracts
-- =============================================  
-- Modify : Sara Lakshmanan 
-- Date : 5/20/2014 
-- Ticket:  Unsubmitted deals not pulling Renewals
-- Added CurrentContractNumber field to the table
-- ============================================= 

  
ALTER procedure [dbo].[usp_contract_ins]  
(@p_username                                        nchar(100),  
 ...
 @p_current_contract_or_Account                      char(10)   = NULL ,
  @p_current_Number                      char(12)   = NULL 
)  
as  
...
declare @w_CurrentNumber  char(12) ;
Select @w_CurrentNumber=@p_current_Number;
declare @w_CurrentContractorAccount  char(10) ;
Select @w_CurrentContractorAccount=@p_current_contract_or_Account;
...
begin  
 ...
 @w_product_id                          = product_id,   
    ...
    @PriceTier        = PriceTier  
      ...
      where contract_nbr                            = @p_contract_nbr   
  --Code commented to allow autogeneration of numbers for Paper contract -08-05-2013
 --if 1 = 0  
 -- begin  
 --   select @w_error                            = 'E'  
 ...
 residual_commission_end, initial_pymt_option_id, sales_manager, evergreen_commission_rate, PriceID, PriceTier, CurrentContAcc,CurrentNumber)   
   ...
   select @p_contract_nbr,  
    ...
    @w_contract_rate_type,  
          ...
          @PriceID,  
          @PriceTier ,
          @w_CurrentContractorAccount, @w_CurrentNumber         
