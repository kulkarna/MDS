...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_PropertyInternalRefByEntKeySelect]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[usp_PropertyInternalRefByEntKeySelect]
GO
...
-- =============================================
-- exec LibertyPower..[usp_PropertyInternalRefByEntKeySelect] 1 , 1
-- ==============================================
