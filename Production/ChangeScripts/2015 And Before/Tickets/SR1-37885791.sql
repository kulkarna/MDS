...
/****** Object:  StoredProcedure [dbo].[usp_document_print_template_table_mulitrate_sel]    Script Date: 11/08/2012 16:30:18 ******/
SET ANSI_NULLS ON
GO
...
-- 11/08/2012	-- RR -- Added kludge for psuedo-rate rate_id=999999999 used in deal capture contract print to prevent bad term/zone data from common_product_rate when found.
-- ==================================================================================
