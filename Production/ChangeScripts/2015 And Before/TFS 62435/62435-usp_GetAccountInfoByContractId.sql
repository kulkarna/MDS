...
/****** Object:  StoredProcedure [dbo].[usp_GetAccountInfoByContractId]    Script Date: 02/10/2015 13:26:23 ******/
SET ANSI_NULLS ON
GO
 ...
 *	Modified:																					*
	02-10-2015 AKulkarni - Added AccountTypeId to the returned object.
...
BEGIN
	...
	SELECT	C.ContractID, C.Number as ContractNumber, C.SignedDate, C.StartDate, 
			...
			AC.AccountContractID, AccountNameID, A.AccountTypeID
	INTO	#Account
