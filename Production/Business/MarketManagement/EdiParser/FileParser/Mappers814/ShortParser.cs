namespace LibertyPower.Business.MarketManagement.EdiParser.FileParser
{
	...
	/// </summary>
	public class ShortParser : PropertyParser<short>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public ShortParser( Expression<Func<EdiAccount, short>> propertySetter, int cellIndex )
		...
		protected override short Parse( ref string fileRowCell, char fieldDelimiter )
		{
			...
			if( string.IsNullOrEmpty( parsedValue ) )
				...
				short.TryParse( parsedValue, out parsed );
