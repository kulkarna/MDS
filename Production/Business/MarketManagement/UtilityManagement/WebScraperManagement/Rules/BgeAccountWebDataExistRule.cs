namespace LibertyPower.Business.MarketManagement.UtilityManagement
{
    ...
    public abstract class BgeAccountWebDataExistsRule : GenericCompositeDataExistsRule<WebAccount>
    {
        /// <summary>
        ...
        public BgeAccountWebDataExistsRule(string ruleName, WebAccount target, string dataDescription)
        ...
        public BgeAccountWebDataExistsRule(string ruleName, BrokenRuleSeverity severity, WebAccount account, string dataDescription)
