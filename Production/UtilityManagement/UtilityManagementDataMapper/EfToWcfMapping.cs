                ...
                if (Utilities.Common.IsDataSetRowValid(dataSet))
                {
                    foreach (DataRow dataRow in dataSet.Tables[0].Rows)
                    {
                        GetAllActiveUtilitiesDumpDataResponseItem getAllUtilitiesDataResponseItem = new GetAllActiveUtilitiesDumpDataResponseItem()
                        {
                            ...
                            UtilityCode = Utilities.Common.NullSafeString(dataRow["UtilityCode"]),
                            UtilityId = Utilities.Common.NullSafeGuid(dataRow["UtilityId"]),
                            UtilityIdInt = Utilities.Common.NullSafeInteger(dataRow["UtilityIdInt"]),
                            ...
                            HIRequestModeType = Utilities.Common.NullSafeString(dataRow["HIRequestModeType"]),
                            HIRequestModeAddress = Utilities.Common.NullSafeString(dataRow["HIRequestModeAddress"]),
                            HIRequestModeEmailTemplate = Utilities.Common.NullSafeString(dataRow["HIRequestModeEmailTemplate"]),
                            HIRequestModeInstructions = Utilities.Common.NullSafeString(dataRow["HIRequestModeInstructions"]),
                            HIRequestModeEnrollmentType = Utilities.Common.NullSafeString(dataRow["HIREQUESTMODEENROLLMENTTYPE"]),
                            HIRequestModeIsLoaRequired = Convert.ToBoolean(Utilities.Common.NullableBoolean(dataRow["HIRequestModeIsLoaRequired"])),
