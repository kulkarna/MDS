...
namespace DataAccessLayerEntityFramework
{
    ...
    public partial class zAuditRequestModeIdr
    {
        ...
        public Nullable<int> UtilitysSlaIdrResponseInDaysPrevious { get; set; }
        public Nullable<int> LibertyPowersSlaFollowUpIdrResponseInDaysPrevious { get; set; }
        public Nullable<bool> IsLoaRequiredPrevious { get; set; }
        public Nullable<decimal> RequestCostAccountPrevious { get; set; }
        ...
        public Nullable<bool> AlwaysRequestPrevious { get; set; }
    }
}
