...
namespace DataAccessLayerEntityFramework
{
    ...
    public partial class zAuditIdrRule
    {
        ...
        public Nullable<int> MinUsageMWhPrevious { get; set; }
        public Nullable<int> MaxUsageMWhPrevious { get; set; }
        public Nullable<bool> IsOnEligibleCustomerListPrevious { get; set; }
        public Nullable<bool> IsHistoricalArchiveAvailablePrevious { get; set; }
        ...
        public Nullable<System.Guid> RequestModeIdrIdPrevious { get; set; }
