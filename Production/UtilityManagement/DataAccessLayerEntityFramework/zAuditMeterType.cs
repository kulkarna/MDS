...
namespace DataAccessLayerEntityFramework
{
    ...
    public partial class zAuditMeterType
    {
        ...
        public string MeterTypeCodePrevious { get; set; }
        public string DescriptionPrevious { get; set; }
        public Nullable<System.Guid> AccountTypeIdPrevious { get; set; }
        public string LpStandardMeterTypePrevious { get; set; }
        public Nullable<int> SequencePrevious { get; set; }
