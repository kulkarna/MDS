...
namespace ExcelBusinessLayer
{
    public class PurchaseOfReceivableTabsBusinessLayer : TabsBusinessLayer
    {
        ...
        public PurchaseOfReceivableTabsBusinessLayer(string messageId, IDataRepository dataRepository, IExcelWorksheetUtility excelWorksheetUtility, ILogger logger, DataSet dataSet, string userName)
            : base(messageId, dataRepository, excelWorksheetUtility, logger, dataSet, userName)
        {
            string method = string.Format("PurchaseOfReceivableTabsBusinessLayer(messageId,dataRepository,excelWorksheetUtility,logger,dataSet,userName:{0})",userName);
            try
            {
