CREATE TABLE [dbo].[AccountInfoAccounts] (
    [FileLogID]             INT            NULL,
    ...
    [DateInserted]          DATETIME       CONSTRAINT [DF_AccountInfoAccounts_DateInserted] DEFAULT (getdate()) NULL,
    [TDSP_AMS_INDICATOR]    VARCHAR (10)   NULL,
    [SWITCH_HOLD_INDICATOR] VARCHAR (1)    NULL,
    CONSTRAINT [PK_AccountInfoAccounts] PRIMARY KEY CLUSTERED ([ESIID] ASC)
);
