 ...
 * PROCEDURE:	[usp_UpdateIsValidFlagMETEDHIECL]
 * PURPOSE:		Update isvalid flag record from [Staging].[FirstEnergyMETEDHIECL] and Fileimport table on the basis of fieldId,
  * HISTORY:		 
 *******************************************************************************
 * 12/08/2014 - Santosh Rao
 * Created.
  *******************************************************************************
  */
CREATE PROCEDURE [dbo].[usp_UpdateIsValidFlagMETEDHIECL]
(
...
Begin Transaction
        Begin try
			 ...
			 Update c
			 Set IsValid=0
			 from [Staging].[FirstEnergyMETEDHIECL] c
