 ...
 * PROCEDURE:	[usp_UpdateIsValidFlagJcplHIECL]
 * PURPOSE:		Update isvalid flag record from [Staging].[FirstEnergyJcplHIECL] and Fileimport table on the basis of fieldId,
  * HISTORY:		 
 *******************************************************************************
 * 12/19/2014 - Santosh Rao
 * Created.
  *******************************************************************************
  */
CREATE PROCEDURE [dbo].[usp_UpdateIsValidFlagJcplHIECL]
(
...
Begin Transaction
        Begin try
			 ...
			 Update c
			 Set IsValid=0
			 from [Staging].[FirstEnergyJcplHIECL] c
