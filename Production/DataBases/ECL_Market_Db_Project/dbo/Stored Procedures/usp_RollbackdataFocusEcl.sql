 ...
 * PROCEDURE:	[usp_RollbackdataFocusEcl]
 * PURPOSE:		Update Is valid flag of [Staging].[FocusEclHU] and Fileimport table on the basis of fieldId
 * HISTORY:		 
 *******************************************************************************
 * 06/16/2015 - Santosh Rao
 * Created.
 
 *******************************************************************************
  */
CREATE PROCEDURE [dbo].[usp_RollbackdataFocusEcl]
(
