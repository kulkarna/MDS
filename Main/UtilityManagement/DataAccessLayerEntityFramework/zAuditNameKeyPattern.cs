...
namespace DataAccessLayerEntityFramework
{
    ...
    public partial class zAuditNameKeyPattern
    {
        ...
        public string NameKeyPatternPrevious { get; set; }
        public string NameKeyPatternDescriptionPrevious { get; set; }
        public Nullable<int> NameKeyAddLeadingZeroPrevious { get; set; }
        public Nullable<int> NameKeyTruncateLastPrevious { get; set; }
        public Nullable<bool> NameKeyRequiredForEDIRequestPrevious { get; set; }
