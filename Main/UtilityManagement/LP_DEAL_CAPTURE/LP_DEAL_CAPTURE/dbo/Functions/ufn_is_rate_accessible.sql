...
CREATE FUNCTION [dbo].[ufn_is_rate_accessible]
...
BEGIN 
	...
	FROM lp_common..common_product_rate pr WITH (NOLOCK)
		LEFT JOIN lp_deal_capture..deal_pricing_detail dpd WITH (NOLOCK) ON pr.product_id = dpd.product_id AND pr.rate_id			= dpd.rate_id  
