...
CREATE PROCEDURE [dbo].[usp_DailyPricingRatesSelect_test]
	@Username					nchar(100),
...
BEGIN
	...
	AND (prh.eff_date = @p_contract_date) -- For custom products, contract date matching is not enforced.
