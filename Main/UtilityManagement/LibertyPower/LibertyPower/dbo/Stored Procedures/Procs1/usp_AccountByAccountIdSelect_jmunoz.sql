...
EXEC LibertyPOwer..[usp_AccountByAccountIdSelect_jmunoz] '2010-0068182'

*/

CREATE PROCEDURE [dbo].[usp_AccountByAccountIdSelect_jmunoz]
	@AccountId	char(12)
AS
BEGIN
    SET NOCOUNT ON;
	...
	*/
	...
	SELECT DISTINCT
			...
			,ACR2.LegacyProductID [ACR2.LegacyProductID]
			,AC_DefaultRate.LegacyProductID [AC_DefaultRate.LegacyProductID]
	...
	JOIN	LibertyPower.dbo.AccountContractRate ACR2 WITH (NOLOCK) 
