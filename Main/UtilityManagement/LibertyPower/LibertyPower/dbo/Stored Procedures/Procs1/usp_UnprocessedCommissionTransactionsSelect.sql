...
/*******************************************************************************
 * usp_UnprocessedCommissionTransactionsSelect
 * To get commission transactions that meet criteria
 * for calculating gross margins adjustments
 *
 * History
 *******************************************************************************
 * 6/24/2009 - Rick Deigsler
 * Created.
 *******************************************************************************
 */
CREATE PROCEDURE [dbo].[usp_UnprocessedCommissionTransactionsSelect]
