...
CREATE PROCEDURE [dbo].[usp_AccountByAccountIdSelect]                                                                                     
	@AccountId	char(12)
AS
BEGIN
    SET NOCOUNT ON;
	...
	*/
	...
	SELECT DISTINCT
			...
			, ISNULL(USAGE.AnnualUsage, (SELECT TOP 1 ISNULL(AnnualUsage, 0) FROM LibertyPower..AccountUsage WITH (NOLOCK) WHERE AccountID = A.AccountID ORDER BY EffectiveDate DESC)) AS AnnualUsage
