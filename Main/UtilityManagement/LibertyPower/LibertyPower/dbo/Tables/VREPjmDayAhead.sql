CREATE TABLE [dbo].[VREPjmDayAhead] (
    ...
    [DateCreated]     DATETIME         CONSTRAINT [DF_VREPjmDayAhead_DateCreated] DEFAULT (getdate()) NOT NULL,
    [CreatedBy]       INT              CONSTRAINT [DF_VREPjmDayAhead_CreatedBy] DEFAULT ((1)) NOT NULL,
    [DateModified]    DATETIME         CONSTRAINT [DF_VREPjmDayAhead_DateModified] DEFAULT (getdate()) NOT NULL,
    [ModifiedBy]      INT              CONSTRAINT [DF_VREPjmDayAhead_ModifiedBy] DEFAULT ((1)) NOT NULL,
    CONSTRAINT [PK_VREPjmDayAhead] PRIMARY KEY CLUSTERED ([ID] ASC)
);
