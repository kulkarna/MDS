...
{
    public class DataRepositoryMockGetPreviousMeterReadDateNoReturnValueNullDataSet : UtilityManagementRepository.IDataRepository
    {
        ...
        public DateTime? usp_MeterReadSchedule_GetPrevious(string messageId, int utilityIdInt, string tripNumber, DateTime referenceDate, string serviceAccountNumber)
        {
            throw new NotImplementedException();
        }
