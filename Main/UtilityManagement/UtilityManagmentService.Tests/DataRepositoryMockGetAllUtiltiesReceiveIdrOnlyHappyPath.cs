...
{
    public class DataRepositoryMockGetAllUtiltiesReceiveIdrOnlyHappyPath : UtilityManagementRepository.IDataRepository
    {
        ...
        public DataSet usp_LpBillingType_Get_BillingTypeExists_UtilityOfferedBillingType_Exists(string messageId, Guid utilityId, Guid porDriverId, Guid loadProfileId, Guid rateClassId, Guid tariffCodeId, Guid utilityOfferedBillingTypeId)
        {
            throw new NotImplementedException();
        }

        public DataSet usp_LpBillingType_Get_BillingTypeExists_UtilityOfferedBillingType_Exists_ByValue(string messageId, string utilityCode, string porDriver, string loadProfileCode, string rateClassCode, string tariffCodeCode, string utilityOfferedBillingType, string lpApprovedBillingType)
        {
            throw new NotImplementedException();
        }
        ...
        public DataSet usp_MeterReadCalendar_IsExactDuplicate(string messageId, string utilityCode, int year, int month, string readCycleId, string readDate, bool isAmr, bool inactive)
        {
            throw new NotImplementedException();
        }
        ...
        public DataSet usp_PaymentTerm_IsExactDuplicate(string messageId, string utilityCode, string accountType, string billingType, string marketId, string paymentTerm, bool inactive)
        {
            throw new NotImplementedException();
        }
        ...
        public DataSet usp_UtilityCompanyGetAllUtilitiesReceiveIdrOnly(string messageId)
        {
            ...
            dataTable.Columns.Add("ReceiveIdrOnly",typeof(int));
            dataTable.Columns.Add("UtilityCode",typeof(string));
            dataTable.Columns.Add("UtilityIdInt",typeof(int));

            DataRow dataRowAce = dataTable.NewRow();
            dataRowAce["ReceiveIdrOnly"]=1;
            dataRowAce["UtilityCode"]="ACE";
            dataRowAce["UtilityIdInt"]=9;
            dataTable.Rows.Add(dataRowAce);

            DataRow dataRowAepce = dataTable.NewRow();
            dataRowAepce["ReceiveIdrOnly"]=1;
            dataRowAepce["UtilityCode"]="AEPCE";
            dataRowAepce["UtilityIdInt"]=1;
            dataTable.Rows.Add(dataRowAepce);
            
            DataRow dataRowOncor = dataTable.NewRow();
            dataRowOncor["ReceiveIdrOnly"]=0;
            dataRowOncor["UtilityCode"]="ONCOR";
            dataRowOncor["UtilityIdInt"]=5;
            dataTable.Rows.Add(dataRowOncor);
