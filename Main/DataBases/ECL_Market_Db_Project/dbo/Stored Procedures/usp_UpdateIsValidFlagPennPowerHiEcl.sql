 ...
 * PROCEDURE:	[usp_UpdateIsValidFlagPennPowerHiEcl]
 * PURPOSE:		Update isvalid flag record from [Staging].[FirstEnergyPennPowerHIECL] and Fileimport table on the basis of fieldId,
  * HISTORY:		 
 *******************************************************************************
 * 12/16/2014 - Santosh Rao
 * Created.
  *******************************************************************************
  */
CREATE PROCEDURE [dbo].[usp_UpdateIsValidFlagPennPowerHiEcl]
(
...
Begin Transaction
        Begin try
				 ...
				 Update c
				 Set IsValid=0
				 from [Staging].[FirstEnergyPennPowerHIECL] c
