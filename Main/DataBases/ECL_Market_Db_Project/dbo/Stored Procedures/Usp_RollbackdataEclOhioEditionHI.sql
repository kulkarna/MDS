 ...
 * PROCEDURE:	[Usp_RollbackdataEclOhioEditionHI]
 * PURPOSE:		Update isvalid flag record from [Staging].[FirstEnergyOhioEditionHIECL] and Fileimport table on the basis of fieldId
 * HISTORY:		 
 *******************************************************************************
 ...
 *******************************************************************************
  */
CREATE PROCEDURE [dbo].[Usp_RollbackdataEclOhioEditionHI]
(
...
Begin Transaction
        Begin try
		 ...
		 --- Updated Is valid flag to 0 which means record is not valid
			 Update c
			 Set IsValid=0
			 from [Staging].[FirstEnergyOhioEditionHIECL] c
