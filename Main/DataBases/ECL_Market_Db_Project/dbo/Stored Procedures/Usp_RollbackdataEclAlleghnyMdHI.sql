 ...
 * PROCEDURE:	[Usp_RollbackdataEclAlleghnyMdHI]
 * PURPOSE:		Delete record from [Staging].[FirstEnergyAlleghnyMdHIECL] and Fileimport table on the basis of fieldId
 * HISTORY:		 
 *******************************************************************************
 * 09/15/2014 - Santosh Rao
 * Created.
 * 12/29/2014 - - Santosh Rao  - Change delete logic to update the is flag in table
 
 *******************************************************************************
  */
CREATE PROCEDURE [dbo].[Usp_RollbackdataEclAlleghnyMdHI]
(
 ...
 Set nocount on;
  ...
  Begin Transaction
        Begin try
			 ...
			 Update c
			 Set IsValid=0
			 from [Staging].[FirstEnergyAlleghnyMdHIECL] c
