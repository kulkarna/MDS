 ...
 * PROCEDURE:	[Usp_RollbackdataEclCEIHI]
 * PURPOSE:		Update isvalid flag record from [Staging].[FirstEnergyCeiHIECL] and Fileimport table on the basis of fieldId
 * HISTORY:		 
 *******************************************************************************
 * 01/28/2015 - Santosh Rao
 * Created.
 
 *******************************************************************************
  */
CREATE PROCEDURE [dbo].[Usp_RollbackdataEclCEIHI]
(
...
Begin Transaction
        Begin try
				 ...
				 Update c
				 Set IsValid=0
				 from [Staging].[FirstEnergyCeiHIECL] c
