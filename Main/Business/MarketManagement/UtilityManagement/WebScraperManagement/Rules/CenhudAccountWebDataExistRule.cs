namespace LibertyPower.Business.MarketManagement.UtilityManagement
{
    ...
    public abstract class CenhudAccountWebDataExistsRule : GenericCompositeDataExistsRule<WebAccount>
    {
        /// <summary>
        ...
        public CenhudAccountWebDataExistsRule(string ruleName, WebAccount target, string dataDescription)
        ...
        public CenhudAccountWebDataExistsRule(string ruleName, BrokenRuleSeverity severity, WebAccount account, string dataDescription)
            : base(ruleName, severity, account, dataDescription)
        {
            account.AccountDataExistsRule = this;
            StringDataExistsRule srule;
