namespace LibertyPower.Business.MarketManagement.UtilityManagement
{
    ...
    public abstract class PecoAccountWebDataExistsRule : GenericCompositeDataExistsRule<WebAccount>
    {
        /// <summary>
        ...
        public PecoAccountWebDataExistsRule(string ruleName, WebAccount target, string dataDescription)
        ...
        public PecoAccountWebDataExistsRule(string ruleName, BrokenRuleSeverity severity, WebAccount account, string dataDescription)
