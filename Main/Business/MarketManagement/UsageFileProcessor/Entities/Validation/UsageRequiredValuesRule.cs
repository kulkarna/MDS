...
namespace UsageFileProcessor.Entities.Validation
{
    public class UsageRequiredValuesRule : BusinessRule
    {
        ...
        public UsageRequiredValuesRule(ParserUsage usage, UtilityAccount account, ParserUtility utility)
        ...
        public override bool Validate()
        {
            ...
            */
            ...
            if (missingFields.Length > 0)
            {
                ...
                {
                    message = string.Format("Required value(s) not found for {0} in  the Accounts Excel Sheet row {1} ", missingAccountFields, ((ParserAccount)account).ExcelRow);
