...
{
    public class MonthScalerEtfCalculator : EtfCalculator
    {
        private const int MonthlyFee = 10;

        public MonthScalerEtfCalculator(CompanyAccount companyAccount, DateTime deenrollmentDate, EtfCalculationType calculationType)
