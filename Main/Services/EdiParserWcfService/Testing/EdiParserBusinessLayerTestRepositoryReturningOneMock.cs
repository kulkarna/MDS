...
namespace Testing
{
    ...
    public class EdiParserBusinessLayerTestRepositoryReturningOneMock : IRepository
    {
    ...
    public class EdiParserBusinessLayerTestRepositoryReturningOneHundredNinetyMock : IRepository
    {
        public DataSet GetBillGroupMostRecent(string messageId, string accountNumber, string utilitycd)
        {
            DataSet dataSet = new DataSet();
    ...
    public class EdiParserBusinessLayerTestRepositoryReturningZeroMock : IRepository
    {
        public DataSet GetBillGroupMostRecent(string messageId, string accountNumber, string utilitycd)
        {
            DataSet dataSet = new DataSet();
    ...
    public class EdiParserBusinessLayerTestRepositoryReturningNegativeOneMock : IRepository
    {
        public DataSet GetBillGroupMostRecent(string messageId, string accountNumber, string utilitycd)
        {
            DataSet dataSet = new DataSet();
    ...
    public class EdiParserBusinessLayerTestRepositoryReturningNullRowMock : IRepository
    {
        public DataSet GetBillGroupMostRecent(string messageId, string accountNumber, string utilitycd)
        {
            DataSet dataSet = new DataSet();
    ...
    public class EdiParserBusinessLayerTestRepositoryReturningNullTableMock : IRepository
    {
        public DataSet GetBillGroupMostRecent(string messageId, string accountNumber, string utilitycd)
        {
            DataSet dataSet = new DataSet();
    ...
    public class EdiParserBusinessLayerTestRepositoryReturningNullDataSetMock : IRepository
    {
        public DataSet GetBillGroupMostRecent(string messageId, string accountNumber, string utilitycd)
        {
