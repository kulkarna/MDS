USE [Libertypower]
GO
/****** Object:  StoredProcedure [dbo].[usp_PricesSelect]    Script Date: 12/18/2012 11:31:37 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    SET NOCOUNT ON;
		...
		BEGIN
			...
			p.PriceTier, p.ProductBrandID, p.GrossMargin, p.ProductCrossPriceID, pb.IsMultiTerm   
