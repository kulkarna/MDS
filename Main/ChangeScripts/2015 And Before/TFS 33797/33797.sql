...
--SET NO_BROWSETABLE OFF
	...
	BEGIN
		...
		exec  usp_UserInsert @UserName=@UName,@Password=@Pwd,@Firstname=@FName,@Lastname=@LName,@Email=@UEmail,@createdBy=49,@legacyID=0,@userType=N'EXTERNAL',@IsActive=@IsActive	
		select @UserId		= userid
			from libertypower..[user] with (nolock)
