...
/****** Object:  StoredProcedure [dbo].[usp_EdiGetAccountAgregatedData]    Script Date: 05/23/2013 11:37:10 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_EdiGetAccountAgregatedData]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_EdiGetAccountAgregatedData]
GO
