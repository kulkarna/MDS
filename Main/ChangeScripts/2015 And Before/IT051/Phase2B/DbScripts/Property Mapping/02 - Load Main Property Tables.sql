...
INSERT [dbo].[PropertyName] ([ID], [Name], [Inactive], [DateCreated], [CreatedBy]) VALUES (1, N'Location', 0, GETDATE(), 0)
INSERT [dbo].[PropertyName] ([ID], [Name], [Inactive], [DateCreated], [CreatedBy]) VALUES (2, N'Profile', 0, GETDATE(), 0)
