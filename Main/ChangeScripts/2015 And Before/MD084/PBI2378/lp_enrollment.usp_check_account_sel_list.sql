USE [lp_enrollment]
GO
/****** Object:  StoredProcedure [dbo].[usp_check_account_sel_list]    Script Date: 11/02/2012 13:33:51 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	CASE WHEN MIN(ISNULL(AC_DefaultRate.AccountContractRateID,0)) = 0 THEN MAX(ACR2.Term)  
				...
				END AS term_months  
	FROM #t2 t (NOLOCK)  
	JOIN LibertyPower.dbo.vw_AccountContractRate ACR2 WITH (NOLOCK) ON T.AccountContractID = ACR2.AccountContractID --AND ACR2.IsContractedRate = 1  
