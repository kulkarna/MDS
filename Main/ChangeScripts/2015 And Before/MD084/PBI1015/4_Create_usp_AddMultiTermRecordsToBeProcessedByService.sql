USE [Libertypower]
GO
/****** Object:  StoredProcedure [dbo].[usp_AddMultiTermRecordsToBeProcessedByService]    Script Date: 11/29/2012 13:27:29 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Modified by Lev Rosenblum 
-- Modified date: <11/29/2012
-- Small adjusment made
-- =============================================
...
DECLARE @EnrolledAccountContractStatusNumber1 varchar(15), @EnrolledAccountContractStatusNumber2 varchar(15), @DeEnrollmentAccountContractStatusNumber varchar(15);
