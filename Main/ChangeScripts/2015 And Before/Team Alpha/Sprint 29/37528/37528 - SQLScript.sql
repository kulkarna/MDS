...
GO
IF EXISTS ( SELECT TOP 1 1 FROM sys.objects WITH (NOLOCK) WHERE name = 'usp_SalesChannelGetByDeviceID' AND type_desc = 'SQL_STORED_PROCEDURE')
DROP PROCEDURE [usp_SalesChannelGetByDeviceID];
GO
-- =============================================
-- Author:		Markus Geiger
-- Create date: 12/10/2013
-- Description:	<Description,,>
-- 4/24/2014 Pradeep Katiyar
-- Added MarginLimit field
-- =============================================
CREATE PROCEDURE [dbo].[usp_SalesChannelGetByDeviceID] 
	@deviceID varchar(50) 
AS
BEGIN
