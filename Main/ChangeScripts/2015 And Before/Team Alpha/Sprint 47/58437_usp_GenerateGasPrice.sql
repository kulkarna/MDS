...
BEGIN TRAN
	...
	BEGIN TRY
		...
		insert into @allowedStartDate values ('02/01/2015')
		...
		BEGIN  
		    ...
		    (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 ...
			 3,0.769,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,14,@segmentId,@zoneId,@serviceClassID,@startDate,
			 6,0.769,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,14,@segmentId,@zoneId,@serviceClassID,@startDate,
			 12,0.789,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,14,@segmentId,@zoneId,@serviceClassID,@startDate,
			 24,0.809,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,14,@segmentId,@zoneId,@serviceClassID,@startDate,
			 36,0.829,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,18,@segmentId,@zoneId,@serviceClassID,@startDate,
			 3,0.629,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,18,@segmentId,@zoneId,@serviceClassID,@startDate,
			 6,0.669,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,18,@segmentId,@zoneId,@serviceClassID,@startDate,
			 12,0.579,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,18,@segmentId,@zoneId,@serviceClassID,@startDate,
			 24,0.599,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketId,18,@segmentId,@zoneId,@serviceClassID,@startDate,
			 36,0.709,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 /*###########################################
						Insert NJ Prices
			 ###########################################*/
			 ...
			 3,0.439,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketIdNJ,38,@segmentId,@zoneId,@serviceClassID,@startDate,
			 6,0.429,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketIdNJ,38,@segmentId,@zoneId,@serviceClassID,@startDate,
			 ...
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketIdNJ,38,@segmentId,@zoneId,@serviceClassID,@startDate,
			 24,0.659,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketIdNJ,38,@segmentId,@zoneId,@serviceClassID,@startDate,
			 36,0.679,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null),
			 (@channelId,@channelGroupId,@channelTypeId,@DefaultProductCrossPriceSetId,@productTypeId,
			 @marketIdNJ,38,@segmentId,@zoneId,@serviceClassID,@startDate,
			 60,0.719,@costRateEffectiveDate,@costRateExpirationDate,@isTermRange,GetDate(),
			 @priceTier,@productBrandId,@grossMargin,null)
