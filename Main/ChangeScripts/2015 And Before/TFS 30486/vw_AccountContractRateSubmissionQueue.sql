...
CREATE VIEW [dbo].[vw_AccountContractRateSubmissionQueue]
AS
...
INNER	JOIN (
                  SELECT	acr1.AccountContractID, 							
							...
							MIN(AccountContractRateID) as AccountContractRateID,
							
							COUNT(DISTINCT acr1.RateStart) as CountOfDistinctTerms,							
							COUNT(acr1.RateStart) as CountOfTerms
...
ON      b.AccountContractID = acr.AccountContractID and b.AccountContractRateID = acr.AccountContractRateID
