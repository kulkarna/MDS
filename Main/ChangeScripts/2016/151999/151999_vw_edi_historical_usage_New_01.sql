...
/****** Object:  View [dbo].[vw_edi_historical_usage_New]    Script Date: 11/22/2016 13:57:39 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_edi_historical_usage_New]'))
DROP VIEW [dbo].[vw_edi_historical_usage_New]
GO

USE [lp_transactions]
GO

/****** Object:  View [dbo].[vw_edi_historical_usage_New]    Script Date: 11/22/2016 13:57:40 ******/
SET ANSI_NULLS ON
GO
...
CREATE view [dbo].[vw_edi_historical_usage_New]  
AS  
  
-- select * from sys.views where name = 'vw_edi_historical_usage'  
-- select top 200 * from vw_edi_historical_usage where AccountNumber in ('0550100327327000169893') 
