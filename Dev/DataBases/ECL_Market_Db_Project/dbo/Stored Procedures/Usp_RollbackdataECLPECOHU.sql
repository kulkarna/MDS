 ...
 * PROCEDURE:	[Usp_RollbackdataECLPECOHU]
 * PURPOSE:		Updated isvalid flag record from [Staging].[PECOECLHU] and Fileimport table on the basis of fieldId
 * HISTORY:		 
 *******************************************************************************
 * 08/25/2014 - Santosh Rao
 * Created.
 
 *******************************************************************************
  */
CREATE PROCEDURE [dbo].[Usp_RollbackdataECLPECOHU]
(
