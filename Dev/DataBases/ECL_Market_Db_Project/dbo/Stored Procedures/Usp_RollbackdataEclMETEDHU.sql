 ...
 * PROCEDURE:	[Usp_RollbackdataEclMETEDHU]
 * PURPOSE:		Update isvalid flag record from [Staging].[FirstEnergyMETEDHUECL] and Fileimport table on the basis of fieldId
 * HISTORY:		 
 *******************************************************************************
 * 02/05/2015 - Santosh Rao
 * Created.
 
 *******************************************************************************
  */
CREATE PROCEDURE [dbo].[Usp_RollbackdataEclMETEDHU]
(
...
Begin Transaction
        Begin try
				 ...
				 Update c
				 Set IsValid=0
				 from [Staging].[FirstEnergyMETEDHUECL] c
