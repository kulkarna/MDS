 ...
 * PURPOSE:		Update isvalid flag record from [Staging].[FirstEnergyPENELECHIECL] and Fileimport table on the basis of fieldId,
  * HISTORY:		 
 *******************************************************************************
 ...
 * Created.
  *******************************************************************************
  */
CREATE PROCEDURE [dbo].[usp_UpdateIsValidFlagPenelecHiEcl]
(
...
Begin Transaction
        Begin try
			 ...
			 Update c
			 Set IsValid=0
			 from [Staging].[FirstEnergyPENELECHIECL] c
