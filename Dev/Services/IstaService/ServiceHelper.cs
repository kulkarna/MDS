...
namespace LibertyPower.DataAccess.WebServiceAccess.IstaWebService
{
	...
	public static class ServiceHelper
	{
		...
		/// <returns></returns>
		public static IstaEnrollmentService.EnrollCustomer BuildCustomer( DataRow accountData, DateTime startDate, string enrollmentType, bool toEsg = false )
		{
            ...
            if (toEsg)
            {
                object fullNameKeyColumn = accountData["FullNameKey"];
                custPremise.NameKey = fullNameKeyColumn == null ? null : fullNameKeyColumn.ToString();
            }
            else
            {
            ...
            string domainUser, string meterType, string utility, string appName)
        {
            ...
            if ((nameKey != null) && (nameKey.Trim() !=""))
               custPremise.NameKey = nameKey.ToUpper();
            else
                custPremise.NameKey = nameKey;
