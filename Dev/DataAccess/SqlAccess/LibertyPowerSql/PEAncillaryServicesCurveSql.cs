...
{
    [Serializable]
    public static class PEAncillaryServicesCurveSql
    {

		/// <summary>
		/// Selects the ancillary service price for the specified iso, zone and date range.
		/// </summary>
		...
		/// <returns>Returns a dataset containing the ancillary service price for the specified iso, zone and date range.</returns>
		public static DataSet SelectAncillaryServicesCurve( string iso, string zoneCode, DateTime beginDate, DateTime endDate )
		{
