...
BEGIN TRY
    ...
    delete from OnlineEnrollment..ZIPCODE where UtilityID=46 and ZoneID=58;
    ...
    Select top 1 [ZipCode],[Latitude],[Longitude],[State],[City],[MarketID],[UtilityID],[ZoneID],[County] into #FinalUIDetails from Zipcode;
