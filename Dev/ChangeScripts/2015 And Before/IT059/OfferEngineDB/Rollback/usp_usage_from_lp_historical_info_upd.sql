...
/****** Object:  StoredProcedure [dbo].[usp_usage_from_lp_historical_info_upd]    Script Date: 07/13/2013 14:04:49 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[usp_usage_from_lp_historical_info_upd]
