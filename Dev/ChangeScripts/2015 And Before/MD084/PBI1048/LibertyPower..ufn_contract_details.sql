USE [Libertypower]
GO
/****** Object:  UserDefinedFunction [dbo].[ufn_contract_details]    Script Date: 11/08/2012 12:12:57 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- select * from libertypower.dbo.ufn_contract_details('2012-0030078')
ALTER FUNCTION [dbo].[ufn_contract_details] (@contract_nbr VARCHAR(25))
...
BEGIN
	...
	LEFT JOIN ProductCrossPriceMulti m
