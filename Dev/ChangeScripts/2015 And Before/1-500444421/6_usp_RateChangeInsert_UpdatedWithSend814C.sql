...
/****** Object:  StoredProcedure [dbo].[usp_RateChangeInsert]    Script Date: 03/14/2013 16:29:41 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_RateChangeInsert]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_RateChangeInsert]
GO
