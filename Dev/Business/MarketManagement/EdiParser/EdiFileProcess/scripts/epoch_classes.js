...
function Epoch(name, mode, targetelement, multiselect) {
    ...
    */
    function calConfig() {
        ...
        self.minDate = new Date(2009, 3, 1);
        self.maxDate = new Date(2020, 6, 31);
    ...
    */
    self.setTarget = function(targetelement, focus) {
        ...
        if (self.mode == 'popup') {
            ...
            self.topOffset = topOffset; //self.tgt.offsetHeight; // the vertical distance (in pixels) to display the calendar from the Top of its input element
            self.leftOffset = leftOffset; 					// the horizontal distance (in pixels) to display the calendar from the Left of its input element
