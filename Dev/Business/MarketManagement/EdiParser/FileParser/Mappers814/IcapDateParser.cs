namespace LibertyPower.Business.MarketManagement.EdiParser.FileParser
{
    ...
    /// </summary>
    public class IcapDateParser : PropertyParser<DateTime>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public IcapDateParser(Expression<Func<EdiAccount, DateTime>> propertySetter, int cellIndex)
        ...
        public override void SetValue(EdiAccount target, ref string fileRowCell, char fieldDelimiter)
        {
            ...
            if ((target.IcapEffectiveDate <= (DateTime)SqlDateTime.MinValue ))
