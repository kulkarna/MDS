namespace LibertyPower.Business.MarketManagement.UtilityManagement
{
	...
	public abstract class WebAccountDataExistsRule : GenericCompositeDataExistsRule<WebAccount>
	{
		/// <summary>
		...
		public WebAccountDataExistsRule( string ruleName, WebAccount target, string dataDescription )
		...
		public WebAccountDataExistsRule( string ruleName, BrokenRuleSeverity severity, WebAccount account, string dataDescription )
			: base( ruleName, severity, account, dataDescription )
		{
			...
			srule = new StringDataExistsRule( BrokenRuleSeverity.Error, account.ZoneCode, "Zone Code" );
			AddDataValidationRule( srule );
