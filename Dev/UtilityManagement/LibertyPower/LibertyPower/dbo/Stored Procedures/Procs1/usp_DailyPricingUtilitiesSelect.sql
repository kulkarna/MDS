			...
			begin
			   ...
			   from (select seq                                 = 1,
					 ...
					 select distinct 
							...
							option_id                           = d.utility_descp,
							return_value                        = ltrim(rtrim(c.utility_id))
					 from Libertypower..UserRole a (NOLOCK),
					      Libertypower..Role b (NOLOCK),
...
GO
EXECUTE sp_addextendedproperty @name = N'VirtualFolder_Path', @value = N'DailyPricing', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'usp_DailyPricingUtilitiesSelect';
