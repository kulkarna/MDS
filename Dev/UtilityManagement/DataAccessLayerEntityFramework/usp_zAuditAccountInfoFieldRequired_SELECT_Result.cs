...
namespace DataAccessLayerEntityFramework
{
    ...
    public partial class usp_zAuditAccountInfoFieldRequired_SELECT_Result
    {
        ...
        public Nullable<System.Guid> AccountInfoFieldId { get; set; }
        public Nullable<System.Guid> AccountInfoFieldIdPrevious { get; set; }
        public string NameUserFriendly { get; set; }
        public string NameUserFriendlyPrevious { get; set; }
        public string NameMachineUnfriendly { get; set; }
        public string NameMachineUnfriendlyPrevious { get; set; }
        public string Description { get; set; }
        public string DescriptionPrevious { get; set; }
        public bool IsRequired { get; set; }
        public Nullable<bool> IsRequiredPrevious { get; set; }
