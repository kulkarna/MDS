...
namespace DataAccessLayerEntityFramework
{
    ...
    public partial class zAuditStrataPattern
    {
        ...
        public string StrataPatternPrevious { get; set; }
        public string StrataPatternDescriptionPrevious { get; set; }
        public Nullable<int> StrataAddLeadingZeroPrevious { get; set; }
        public Nullable<int> StrataTruncateLastPrevious { get; set; }
        public Nullable<bool> StrataRequiredForEDIRequestPrevious { get; set; }
