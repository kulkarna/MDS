...
namespace DataAccessLayerEntityFramework
{
    ...
    public partial class usp_zAuditLpBillingType_SELECT_Result
    {
        ...
        public string PorDriverPrevious { get; set; }
        ...
        public string TariffCodePrevious { get; set; }
        public string DefaultBillingType { get; set; }
        public string DefaultBillingTypePrevious { get; set; }
