 ...
 *******************************************************************************/
CREATE PROCEDURE [dbo].[usp_DailyPricingTermsSelect_test]
...
BEGIN
	...
	SELECT	distinct option_id = term_months, return_value = term_months
    FROM lp_common..product_rate_history
    WHERE eff_date = @p_contract_date
    AND product_id = @p_product_id
    AND (@p_contract_eff_start_date is null OR contract_eff_start_date = @p_contract_eff_start_date)
