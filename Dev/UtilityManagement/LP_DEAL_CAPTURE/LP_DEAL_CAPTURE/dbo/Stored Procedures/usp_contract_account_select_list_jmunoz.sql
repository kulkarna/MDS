...
CREATE procedure [dbo].[usp_contract_account_select_list_jmunoz]
...
inner join lp_common..common_product_rate pr WITH (NOLOCK) ON ca.product_id = pr.product_id AND ca.rate_id = pr.rate_id
