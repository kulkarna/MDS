CREATE TABLE [dbo].[zOE_OFFER_AUDIT] (
    ...
    [AUDIT_CHANGE_DATE]                             DATETIME        CONSTRAINT [DF_zOE_OFFER_AUDIT_AUDIT_CHANGE_DATE2] DEFAULT (getdate()) NOT NULL,
    [AUDIT_CHANGE_BY]                               VARCHAR (30)    CONSTRAINT [DF_zOE_OFFER_AUDIT_AUDIT_CHANGE_BY2] DEFAULT (substring(suser_sname(),(1),(30))) NOT NULL,
    [AUDIT_CHANGE_LOCATION]                         VARCHAR (30)    CONSTRAINT [DF_zOE_OFFER_AUDIT_AUDIT_CHANGE_LOCATION2] DEFAULT (substring(host_name(),(1),(30))) NOT NULL,
    CONSTRAINT [PK_zOE_OFFER2] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90)
);
